...
app.post('/guardar-contactos', (req, res) => {
  ...
  let values = [1, 1, NombreContacto1, DireccionContacto1, TelefonoContacto1, CelularContacto1, PuestoContacto1, EmailContacto1, EmailContactoAdicional1, ObservacionesContacto1];
  ...
  connection.query(sql, values, (err, result) => {
      ...
      for (let i = 2; i <= 3; i++) { // Cambia los límites según tu límite de contactos dinámicos
          ...
          if (NombreContacto || DireccionContacto || TelefonoContacto || CelularContacto || PuestoContacto || EmailContacto || EmailContactoAdicional || ObservacionesContacto) {
              ...
              values = [1, i, NombreContacto, DireccionContacto, TelefonoContacto, CelularContacto, PuestoContacto, EmailContacto, EmailContactoAdicional, ObservacionesContacto];
